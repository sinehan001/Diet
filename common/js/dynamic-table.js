...
"use strict";
        ...
        jQuery('#sample_1 .group-checkable').on('change', function () {
        ...
        jQuery('#sample_2 .group-checkable').on('change', function () {
            var set = jQuery(this).attr("data-set");
            var checked = jQuery(this).is(":checked");
            jQuery(set).each(function () {
                if (checked) {
        ...
        jQuery('#sample_3 .group-checkable').on('change', function () {
            var set = jQuery(this).attr("data-set");
            var checked = jQuery(this).is(":checked");
            jQuery(set).each(function () {
                if (checked) {
