    ...
    $(".appointment_edit").on("click", ".editAppointmentButton", function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#editAppointmentForm').find('[name="dietician"]').val(response.appointment.dietician).end()
                ...
                $('.js-example-basic-single.dietician').val(response.appointment.dietician).trigger('change');



                var date = $('#date1').val();
                var dieticianr = $('#adieticians1').val();
                var appointment_id = $('#appointment_id').val();

                $.ajax({
                    url: 'schedule/getAvailableSlotByDieticianByDateByAppointmentIdByJason?date=' + date + '&dietician=' + dieticianr + '&appointment_id=' + appointment_id,
                    method: 'GET',
                    data: '',
                    dataType: 'json',
                    success: function (response) {
...
$(document).ready(function () {
    ...
    $(".dietician_div").on("change", "#adieticians", function () {
        "use strict";

        var iid = $('#date').val();
        var dieticianr = $('#adieticians').val();
        $('#aslots').find('option').remove();

        $.ajax({
            url: 'schedule/getAvailableSlotByDieticianByDateByJason?date=' + iid + '&dietician=' + dieticianr,
            method: 'GET',
            data: '',
            dataType: 'json',
            success: function (response) {
...
$(document).ready(function () {
    "use strict";
    $(".dietician_div1").on("change", "#adieticians1", function () {
        "use strict";
        ...
        $.ajax({
            url: 'schedule/getAvailableSlotByDieticianByDateByAppointmentIdByJason?date=' + date + '&dietician=' + dieticianr + '&appointment_id=' + id,
            method: 'GET',
            data: '',
            dataType: 'json',
             success: function (response) {
...
function dateChanged1() {
    ...
    $.ajax({
        url: 'schedule/getAvailableSlotByDieticianByDateByAppointmentIdByJason?date=' + iid + '&dietician=' + dieticianr + '&appointment_id=' + id,
        method: 'GET',
        data: '',
        dataType: 'json',
        success: function (response) {
...
$(document).ready(function () {
    ...
    $("#add_dietician").select2({
        placeholder: select_dietician,
        allowClear: true,
        ajax: {
            url: 'dietician/getDieticianWithAddNewOption',
            type: "post",
            dataType: 'json',
            delay: 250,
            data: function (params) {
