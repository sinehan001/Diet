                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <?php foreach ($accountants as $accountant) { ?>
                            <tr class="">
                                ...
                                <td class="no-print">
                                    <a class="btn btn-info btn-xs btn_width add_payment_button" href="finance/allUserActivityReport?user=<?php echo $accountant_ion_user_id; ?>"><i class="fa fa-info"></i> Details</a>
                                </td>
                            </tr>
                        <?php } ?>
                        <?php foreach ($receptionists as $receptionist) { ?>
                            <tr class="">
                                ...
                                <td class="no-print">
                                    <a class="btn btn-info btn-xs btn_width add_payment_button" href="finance/allUserActivityReport?user=<?php echo $receptionist_ion_user_id; ?>"><i class="fa fa-info"></i> Details</a>
                                </td>
                            </tr>
                        <?php } ?>
                        </tbody>
