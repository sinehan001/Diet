                ...
                <form role="form" action="schedule/addSchedule" class="clearfix" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="input-group bootstrap-timepicker timepickers_time">
                            <input type="text" class="form-control timepicker-default" id="s_time" name="s_time"  value='' required="">
                    ...
                    <div class="form-group bootstrap-timepicker col-md-6">
                        ...
                        <div class="input-group bootstrap-timepicker timepickere_time">
                            <input type="text" class="form-control timepicker-default" id="e_time" name="e_time"  value='' required="">
                            <span class="input-group-btn">
                                <button class="btn btn-default" type="button"><i class="fa fa-clock"></i></button>
                            </span>
                        </div>
                    ...
                    <div class="form-group col-md-12">
                        <button type="submit" name="submit" id="addSubmit" class="btn btn-info pull-right"> <?php echo lang('submit'); ?></button>
                    </div>
                </form>
            ...
            <div class="modal-body">
                <form role="form" id="editTimeSlotForm" action="schedule/addSchedule" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1"> <?php echo lang('start_time'); ?> &#42;</label>
                        <div class="input-group bootstrap-timepicker timepickers_time1">
                            <input type="text" class="form-control timepicker-default" id="s_time1" name="s_time"  value='' required="">
                            <span class="input-group-btn">
                                <button class="btn btn-default" type="button"><i class="fa fa-clock"></i></button>
                            </span>
                        </div>
                    ...
                    <div class="form-group bootstrap-timepicker">
                        <label for="exampleInputEmail1"> <?php echo lang('end_time'); ?> &#42;</label>
                        <div class="input-group bootstrap-timepicker timepickere_time1">
                            <input type="text" class="form-control timepicker-default" name="e_time" id="e_time1"  value='' required="">
                            <span class="input-group-btn">
                                <button class="btn btn-default" type="button"><i class="fa fa-clock"></i></button>
                            </span>
                        </div>
