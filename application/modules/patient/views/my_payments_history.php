    ...
    <section class="wrapper site-min-height">
                            ...
                            foreach ($payments as $payment) {
                                if ($payment->date == $value) {
                                    ...
                                    <tr class="">
                                        ...
                                        <td  class="no-print"> 
                                            <a class="btn-xs invoicebutton" title="<?php echo lang('invoice'); ?>" href="patient/myInvoice?id=<?php echo $payment->id; ?>"><i class="fas fa-file-invoice"></i> </a>
                                        </td>
                                    </tr>
        ...
        <section class="no-print col-md-4">
            ...
            <div class="">
                    ...
                    <table class="table table-hover personal-task">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="tel:<?php echo $patient->phone; ?>"><?php echo $patient->phone; ?></a></td>
                ...
                <section class="panel red due_amount_div">
                    <div class="weather-bg">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-xs-4">
