                        ...
                        <a data-toggle="modal" href="#myModal">
                            <div class="btn-group pull-right">
                                <button id="" class="btn green btn-xs">
                                    <i class="fa fa-plus-circle"></i>  <?php echo lang('add_dietician_visit'); ?> 
                                </button>
                            </div>
                        </a>
                ...
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th><?php echo lang('dietician'); ?> <?php echo lang('name'); ?></th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">  <?php echo lang('add_dietician_visit'); ?></h4>
            </div>
            <div class="modal-body">
                <form role="form" action="dietician/dieticianvisit/addNew" class="clearfix" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="exampleInputEmail1">  <?php echo lang('dietician'); ?></label> 
                        <select class="form-control m-bot15 dietician" id="adieticians" name="dietician" value='' required="">  
...
<div class="modal fade" id="myModal2" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">  <?php echo lang('edit_dietician_visit'); ?></h4>
            </div>
            <div class="modal-body">
                <form role="form" id="editDieticianvisitForm" class="clearfix" action="dietician/dieticianvisit/addNew" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="exampleInputEmail1">  <?php echo lang('dietician'); ?></label> 
                        <select class="form-control m-bot15 dietician" id="adieticians1" name="dietician" value='' required="">  
...
<script type="text/javascript">var select_dietician = "Select Dietician";</script>
<script src="common/extranal/js/dietician/dietician_visit.js"></script>
