...
<section id="main-content">
    <section class="wrapper site-min-height">
        <!-- page start-->
  <link href="common/extranal/css/dietician/details.css" rel="stylesheet">
                ...
                <div class="panel col-md-12">
                    <div class="tab-content">
                        ...
                        <div id="prescription1" class="tab-pane"> <div class="">
                                <?php if ($this->ion_auth->in_group(array('Dietician'))) { ?>
                                    <div class=" no-print">
                                            ...
                                            <?php foreach ($prescriptions as $prescription) { ?>
                                                <tr class="">
                                                    ...
                                                    <td class="no-print">
                                                        ...
                                                        <?php if ($this->ion_auth->in_group('Dietician')) { ?>
                                            ...
                                            foreach ($schedules as $schedule) {
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-info btn-xs btn_width delete_button" href="schedule/deleteSchedule?id=<?php echo $schedule->id; ?>&dietician=<?php echo $schedule->dietician; ?>&weekday=<?php echo $schedule->weekday; ?>&all=all" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"> </i> <?php echo lang('delete'); ?></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
                                        ...
                                        foreach ($holidays as $holiday) {
                                            ...
                                            <tr class="">
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-info btn-xs btn_width delete_button" href="schedule/deleteHoliday?id=<?php echo $holiday->id; ?>&dietician=<?php echo $dietician->id; ?>&redirect=dietician/details" onclick="return confirm('Are you sure you want to delete this item?');"><i class="fa fa-trash"> </i> <?php echo lang('delete'); ?></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
                ...
                <aside class="profile-nav">
                    <section class="">
                        <div class="user-heading round">
                            <?php if (!empty($dietician->img_url)) { ?>
                                <a href="#">
                                    <img src="<?php echo $dietician->img_url; ?>" alt="">
                                </a>
                            <?php } ?>
                            <h1> <?php echo $dietician->name; ?> </h1>
                            <p> <?php echo $dietician->email; ?> </p>
                        </div>

                        <ul class="nav nav-pills nav-stacked">
                            <li class="active"> <?php echo lang('dietician'); ?> <?php echo lang('name'); ?><span class="label pull-right r-activity"><?php echo $dietician->name; ?></span></li>
                            <li>  <?php echo lang('dietician_id'); ?> <span class="label pull-right r-activity"><?php echo $dietician->id; ?></span></li>
                            <li>  <?php echo lang('profile'); ?><span class="label pull-right r-activity"><?php echo $dietician->profile; ?></span></li>
                            <li>  <?php echo lang('address'); ?><span class="label pull-right r-activity"><?php echo $dietician->address; ?></span></li>
                            <li>  <?php echo lang('phone'); ?><span class="label pull-right r-activity"><?php echo $dietician->phone; ?></span></li>
                            <li>  <?php echo lang('email'); ?><span class="label pull-right r-activity"><?php echo $dietician->email; ?></span></li>
                        </ul>
...
if ($this->ion_auth->in_group('Dietician')) {
    $dietician_id = $this->db->get_where('dietician', array('ion_user_id' => $current_user))->row()->id;
}
?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="appointment/addNew" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-4 panel dietician_div">
                        <label for="exampleInputEmail1">  <?php echo lang('dietician'); ?> &#42;</label>
                        <select class="form-control js-example-basic-single" id="adieticians" name="dietician" value='' required="">  
                            <option value="">Select .....</option>
                            <option value="<?php echo $dietician->id; ?>"><?php echo $dietician->name; ?> </option>
                        </select>
                    </div>
                    ...
                    <input type="hidden" name="redirect" value='dietician/details'>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editAppointmentForm" action="appointment/addNew" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-4 panel dietician_div1">
                        <label for="exampleInputEmail1">  <?php echo lang('dietician'); ?> &#42;</label>
                        <select class="form-control m-bot15 js-example-basic-single dietician" id="adieticians1" name="dietician" value='' required="">  
                            <option value="">Select .....</option>
                            <option value="<?php echo $dietician->id; ?>"><?php echo $dietician->name; ?> </option>
                        </select>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="schedule/addHoliday" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="dietician" value='<?php echo $dietician->id; ?>'>
                    <input type="hidden" name="redirect" value='dietician/details'>
                    <input type="hidden" name="id" value=''>
                    <div class="form-group col-md-12">
                        <button type="submit" name="submit" class="btn btn-info pull-right"> <?php echo lang('submit'); ?></button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="schedule/addSchedule" class="clearfix row" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="dietician" value='<?php echo $dietician_id; ?>'>
                    <input type="hidden" name="redirect" value='dietician/details'>
                    <input type="hidden" name="id" value=''>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="editTimeSlotForm" action="schedule/addSchedule" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="dietician" value="<?php echo $dieticianr; ?>">
                    <input type="hidden" name="redirect" value='dietician/details'>
                    <input type="hidden" name="id" value=''>
                    <button type="submit" name="submit" class="btn btn-info"> <?php echo lang('submit'); ?></button>
                </form>
...
<script type="text/javascript">var select_dietician = "<?php echo lang('select_dietician'); ?>";</script>
<script type="text/javascript">var select_patient = "<?php echo lang('select_patient'); ?>";</script>
<script type="text/javascript">var language = "<?php echo $this->language; ?>";</script>

<script src="common/extranal/js/dietician/details.js"></script>
