    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <?php echo lang('dietician'); ?>s   
                <div class="col-md-4 no-print pull-right"> 
                    <a href="dietician.php"></a>
            ...
            <div class="panel-body">
                <div class="adv-table editable-table ">
                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                <th><?php echo lang('dietician'); ?> <?php echo lang('id'); ?></th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">  <?php echo lang('add_new_dietician'); ?></h4>
            </div>
            <div class="modal-body row">
                <form role="form" action="dietician/addNew" class="clearfix" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="myModal2" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"> <?php echo lang('edit_dietician'); ?></h4>
            </div>
            <div class="modal-body">
                <form role="form" id="editDieticianForm" class="clearfix" action="dietician/addNew" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-6">
                        <label for="exampleInputEmail1"><?php echo lang('name'); ?> &#42;</label>
                        <input type="text" class="form-control" name="name"  value='' placeholder="" required="">
                    </div>
...
<div class="modal fade" id="infoModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title"> <?php echo lang('dietician'); ?> <?php echo lang('info'); ?></h4>
            </div>
            <div class="modal-body">
                <form role="form" id="editDieticianForm1" class="clearfix" action="dietician/addNew" method="post" enctype="multipart/form-data">
...
<script src="common/extranal/js/dietician/dietician.js"></script>