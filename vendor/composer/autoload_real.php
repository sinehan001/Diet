...
class ComposerAutoloaderInit75b452f67b5d695d07188d55772b12a6
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit75b452f67b5d695d07188d55772b12a6::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire75b452f67b5d695d07188d55772b12a6($fileIdentifier, $file);
        }
...
function composerRequire75b452f67b5d695d07188d55772b12a6($fileIdentifier, $file)
{
